...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let usrAgentRepo = crypto_1.default.createHash('sha256').update(`${process.env.GITHUB_REPOSITORY}`).digest('hex');
            ...
            core_1.default.debug("Predeployment Steps Started");
            ...
            core_1.default.debug("Deployment Step Started");
            ...
            //    "name": taskParams.containerName
            //}
            let containerAppDeploymentResult = yield client.containerApps.beginCreateOrUpdate(taskParams.resourceGroup, taskParams.containerAppName, containerAppEnvelope);
            if (containerAppDeploymentResult.getOperationState.toString() == "Succeeded") {
                ...
                core_1.default.debug("Deployment Result: " + containerAppDeploymentResult);
            }
            else {
                core_1.default.debug("Deployment Result: " + containerAppDeploymentResult);
            ...
            core_1.default.debug("Deployment Failed with Error: " + error);
            //core.setFailed(error);
        }
        finally {
            // Reset AZURE_HTTP_USER_AGENT
            core_1.default.exportVariable('AZURE_HTTP_USER_AGENT', prefix);
        }
    });
}
