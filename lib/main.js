    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const containerAppEnvelope = {
                location: "East US",
                managedEnvironmentId: "/subscriptions/a4deccb1-a1f6-40cb-a923-f55a7d22c32d/resourceGroups/sample-rg/providers/Microsoft.App/managedEnvironments/my-container-env",
                template: {
                    containers: [
                        {
            ...
            console.log((_a = containerAppDeploymentResult.getResult()) === null || _a === void 0 ? void 0 : _a.toString());
            console.log("");
            console.log("getResult");
